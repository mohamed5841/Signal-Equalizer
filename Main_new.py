...
import pandas as pd
import copy
Ui_MainWindow, QtBaseClass = uic.loadUiType("equalizer_2.ui")
...
#  self.ECG_frequncy_slices={self.VerticalSlider_Channel_8:[56, 300]
...
# was from 10 to 30
        ...
        # uniform_frequncy_slices={self.VerticalSlider_Channel_10:self.uniform_ranges[9]
        #      ,self.VerticalSlider_Channel_9:self.uniform_ranges[8]
        #      ,self.VerticalSlider_Channel_8:self.uniform_ranges[7]
        #      ,self.VerticalSlider_Channel_7:self.uniform_ranges[6],
        #      self.VerticalSlider_Channel_6:self.uniform_ranges [5]
        #      ,self.VerticalSlider_Channel_5:self.uniform_ranges[4]
        #      ,self.VerticalSlider_Channel_4:self.uniform_ranges[3]
        #      ,self.VerticalSlider_Channel_3:self.uniform_ranges[2],
        #      self.VerticalSlider_Channel_2:self.uniform_ranges [1]
        #      ,self.VerticalSlider_Channel_1:self.uniform_ranges[0]
        #      }
        ...
        self.uniform_obj=mode("mixed2_signal.csv",False)
        self.uniform_obj.freq_slices=None
        
        ecg_obj=mode("Normal.csv" , False)
